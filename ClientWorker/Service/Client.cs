...
namespace ClientWorker
{
    ...
    public class Client : IEvents
    {
        ...
        public int Port = StartData.port;
        ...
        private class Proxy<T> : RealProxy where T : class
        {
            ...
            public Proxy(Client client) : base(typeof(T))
            {
                this.client = client;
            }
        ...
        private Unit Execute(string MethodName, object[] parameters)
        {
            lock (syncLock)
            {
        ...
        private void SyncResult(Unit msg)
